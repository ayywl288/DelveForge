 ...
 */
public final class UserProfileCandidates {
     ...
     */
    public static UserProfile loadCopy(UserProfileRepository repository, UserProfileId userProfileId) {
        return copyOf(repository.findById(userProfileId)
                .orElseThrow(() -> new UserProfileNotFoundException(userProfileId)));
    }

    public static UserProfile copyOf(UserProfile profile) {
